  ...
  methods: {
    ...
    save_this_image(){
        ...
        for (var f in this.filelist) {
          ...
          axios.post("/admin/add_one_image_to_category/"+category_id, bodyFormData, config)
           .then((response) => {
               ...
               this.$forceUpdate();
                ...
                {
                    $('#img_'+response.data.category_id).attr('src', '/image_resize/resize/media/'+response.data.i+'?w=300&h=300&q=80')
                }
                this.files_loading--;
